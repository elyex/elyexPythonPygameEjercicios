...
#--------------------------------------------
#  Programa: Uso de Claces en Pygame con fondos, rectangulos aleatorios, colision, sonido
#--------------------------------------------
import pygame
import random
...
def main():
	...
	pygame.mixer.music.load("EfectoDisparos.mp3")
	sonido1=pygame.mixer.Sound("EfectoDisparos2.mp3")
	recs1=Recs(25)
